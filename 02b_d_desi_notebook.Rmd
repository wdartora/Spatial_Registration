---
title: "02_b_d_script_notebook.R"
author: "Jason Mares"
date: "2025-03-11"
...
Load in required libraries and set output directories
...
Formats data into producing into a black and white image.
...
## STEP 3  (do in base R not R Studio)
Landmarking step, pretty much the same as that done for Visium
...
## STEP 4 - PYTHON script 02c_DESI

## STEP 5 

Link ion data to Visium spots
...
and then three possible steps :
a. No scaling/transformtion
b. filter based on pre-selected list for high nois ions
c. filter based on summry statistics
...
## Step 7 
Add ion data to Visium Seurat Object
