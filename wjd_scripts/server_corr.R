...
# --- Caminhos base ---
seurat_dir <- "D:/William/Data_base_VISIUM/Projects/Proj01/data_seurat"
ion_file <- "D:/William/Data_base_VISIUM/Projects/Proj01/integration_outputs/visium_desi_files/spots_ion_data_0509.csv"
output_dir <- "D:/William/Data_base_VISIUM/Projects/Proj01/correlation_per_slice_server"
...
for (seurat_path in seurat_files) {
  ...
  if (length(common_barcodes) < 3) {
    cat("  ?????? Pulando por poucos barcodes.\n")
    next
  }
