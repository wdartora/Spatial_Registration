...
VisiumData<-read.VisiumSpatialRNA("W:/Data_base_VISIUM/MPI/data/ABCA7-3-a1-8_BIN1-6-a3-8/outs/")
...
Counts<-Read10X_h5("W:/Data_base_VISIUM/MPI/data/ABCA7-3-a1-8_BIN1-6-a3-8/outs/filtered_feature_bc_matrix.h5")
...
resultsdir <- "W:/Data_base_VISIUM/Projects/Proj01/deconvolution/ABCA7-3-a1-8_BIN1-6-a3-8"
...
coords$barcode <- rownames(coords)
coords$sample <- ifelse(coords$y < 115, "ABCA7-3-a1-8", "BIN1-6-a3-8")
...
# Load Visium data directly from Space Ranger output directory
#VisiumData<-read.VisiumSpatialRNA("../outs/")
VisiumData<-read.VisiumSpatialRNA("W:/Data_base_VISIUM/MPI/data/ABCA7-8-a3_BIN1-5-a1/outs/")

# Create a list of barcodes from the column names of the count matrix
barcodes <- colnames(VisiumData@counts)

# Load single cell data from Cell Ranger output directory
Counts<-Read10X_h5("W:/Data_base_VISIUM/MPI/data/ABCA7-8-a3_BIN1-5-a1/outs/filtered_feature_bc_matrix.h5")
...
#Results 
# Create the output directory in your working directory
resultsdir <- "W:/Data_base_VISIUM/Projects/Proj01/deconvolution/ABCA7-8-a3_BIN1-5-a1"
dir.create(resultsdir) 
...
# Adiciona coluna com os barcodes e divide as regiões
coords$barcode <- rownames(coords)
coords$sample <- ifelse(coords$y < 107, "ABCA7-8-a3", "BIN1-5-a1")
...
# Load Visium data directly from Space Ranger output directory
#VisiumData<-read.VisiumSpatialRNA("../outs/")
VisiumData<-read.VisiumSpatialRNA("W:/Data_base_VISIUM/MPI/data/WTP-2-a1-8_PICALM-10-a1-7/outs/")

# Create a list of barcodes from the column names of the count matrix
barcodes <- colnames(VisiumData@counts)

# Load single cell data from Cell Ranger output directory
Counts<-Read10X_h5("W:/Data_base_VISIUM/MPI/data/WTP-2-a1-8_PICALM-10-a1-7/outs/filtered_feature_bc_matrix.h5")
...
#Results 
# Create the output directory in your working directory
resultsdir <- "W:/Data_base_VISIUM/Projects/Proj01/deconvolution/WTP-2-a1-8_PICALM-10-a1-7"
dir.create(resultsdir) 
...
# Adiciona coluna com os barcodes e divide as regiões
coords$barcode <- rownames(coords)
coords$sample <- ifelse(coords$y < 87, "WTP-2-a1-8", "PICALM-10-a1-7")
...
# Load Visium data directly from Space Ranger output directory
#VisiumData<-read.VisiumSpatialRNA("../outs/")
VisiumData<-read.VisiumSpatialRNA("W:/Data_base_VISIUM/MPI/data/WTP-5-a2-8_PICALM-10-a2-8/outs/")

# Create a list of barcodes from the column names of the count matrix
barcodes <- colnames(VisiumData@counts)

# Load single cell data from Cell Ranger output directory
Counts<-Read10X_h5("W:/Data_base_VISIUM/MPI/data/WTP-5-a2-8_PICALM-10-a2-8/outs/filtered_feature_bc_matrix.h5")
...
#Results 
# Create the output directory in your working directory
resultsdir <- "W:/Data_base_VISIUM/Projects/Proj01/deconvolution/WTP-5-a2-8_PICALM-10-a2-8"
dir.create(resultsdir) 
...
# Adiciona coluna com os barcodes e divide as regiões
coords$barcode <- rownames(coords)
coords$sample <- ifelse(coords$y < 95, "WTP-5-a2-8", "PICALM-10-a2-8")
...
# Load Visium data directly from Space Ranger output directory
#VisiumData<-read.VisiumSpatialRNA("../outs/")
VisiumData<-read.VisiumSpatialRNA("W:/Data_base_VISIUM/MPI/data/WTP-5-a7-8_PICALM-5-a1-8/outs/")

# Create a list of barcodes from the column names of the count matrix
barcodes <- colnames(VisiumData@counts)

# Load single cell data from Cell Ranger output directory
Counts<-Read10X_h5("W:/Data_base_VISIUM/MPI/data/WTP-5-a7-8_PICALM-5-a1-8/outs/filtered_feature_bc_matrix.h5")
...
#Results 
# Create the output directory in your working directory
resultsdir <- "W:/Data_base_VISIUM/Projects/Proj01/deconvolution/WTP-5-a7-8_PICALM-5-a1-8"
dir.create(resultsdir) 
...
# Adiciona coluna com os barcodes e divide as regiões
coords$barcode <- rownames(coords)
coords$sample <- ifelse(coords$y < 110, "WTP-5-a7-8", "PICALM-5-a1-8")
